...
LS_RANK_START = 20                 # 启动感知监控池：24h成交额排名起始（第20名起）
LS_RANK_END = 220                  # 启动感知监控池：24h成交额排名结束（到第220名，共200个）
...
CANDIDATE_MIN_QUOTE_VOLUME = 5_000_000  # 候选池僵尸币过滤：24h 成交额 < 500万 USDT 不入池（自选除外）
